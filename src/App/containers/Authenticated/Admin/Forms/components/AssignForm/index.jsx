...
export default class AssignForm extends Component {
    ...
    onSubmit = () => {
        const { hide, submitAssign, form } = this.props;
    ...
    onOpenChange = (e) => {
        this.setState({ assign: { ...this.state.assign, open: e } });
    }

    onCloseChange = (e) => {
        this.setState({ assign: { ...this.state.assign, close: e } });
    }
            ...
            >
                ...
                <div className="dialog-row">
                    <DatePicker
                        ...
                        label='Date Open'
                        className='md-cell'
                        value={moment(assign.open).format('MMM D, YYYY')}
                    ...
                    <DatePicker
                        ...
                        label='Date Closed'
                        className='md-cell'
                        value={moment(assign.close).format('MMM D, YYYY')}
